...
legend( x="topright", 
        ...
        col=c("black","red","blue"), lwd=1, cex=0.6 , bty="n", inset = 0.05)

plot(subset.power_data$newdate,subset.power_data$Voltage,type="n",
     xlab="datetime",ylab="Voltage")
lines(subset.power_data$newdate,subset.power_data$Voltage)

plot(subset.power_data$newdate,subset.power_data$Global_reactive_power,type="n",
     xlab="datetime",ylab="Global_reactive_power")
lines(subset.power_data$newdate,subset.power_data$Global_reactive_power)
